...
export default class Huan1 extends PureComponent {
  constructor(props) {
        super(props);
        this.state = {
            list:[],
...
// 组件挂载之前
  ...
  loadData() {
    const parkid = 5;
      HttpClientImmidIot.query('/parking-report/dataVisualizations/parking/'+parkid+'/parkingTimeDistribution', 'GET', null, this.handleQueryData.bind(this));
    }
    gettime(str){
